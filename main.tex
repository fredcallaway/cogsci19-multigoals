...
Many of the hallmarks of higher level human cognition, such as problem solving, strategic reasoning, and planning may rely on a single core capacity: search. 

The formalization of human problem solving as search over a decision tree goes back at least to the work of \citet{NewellSimon1972}. ...

For a process-level theory of human search to be complete, two 


More recently, search models have been popularized 

\citet{Keramati2016} present a model in which cached "habitual" values stand in for the value that would be revealed by further search.
